...
class CameraController(
    ...
    private fun getClosestFpsRange(cameraId: String, fps: Int): Range<Int> {
        ...
        AVLog.d("CameraController", "Supported FPS range list: $fpsRangeList")
        ...
        AVLog.d("CameraController", "Selected Fps range $selectedFpsRange")
    ...
    private class CameraDeviceCallback(
        ...
        override fun onDisconnected(camera: CameraDevice) {
            AVLog.d("CameraController", "Camera ${camera.id} has been disconnected")
        }

        override fun onError(camera: CameraDevice, error: Int) {
            AVLog.d("CameraController", "Camera ${camera.id} is in error $error")
    ...
    private class CameraCaptureSessionCallback(
        ...
        override fun onConfigureFailed(session: CameraCaptureSession) {
            AVLog.d("CameraController", "Camera Session configuration failed")
    ...
    private val captureCallback = object : CameraCaptureSession.CaptureCallback() {
        override fun onCaptureFailed(
            ...
            AVLog.d("CameraController", "Capture failed  with code ${failure.reason}")
        }
...
//            AVLog.d("CameraController", "onCaptureStarted")
//        }
//
...
//            AVLog.d("CameraController", "onCaptureCompleted")
//        }
    }
