 ...
 */
internal  fun Context.getCameraCharacteristics(cameraId: String): CameraCharacteristics {
 ...
 */
internal fun Context.getCameraList(): List<String> {
 ...
 */
internal fun Context.getBackCameraList() =
 ...
 */
internal fun Context.getFrontCameraList() =
 ...
 * @return List of front camera ids
 */
internal fun Context.getExternalCameraList() =
 ...
 */
internal fun Context.isBackCamera(cameraId: String) =
 ...
 */
internal fun Context.isFrontCamera(cameraId: String) =
 ...
 */
internal fun Context.isExternalCamera(cameraId: String) =
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
 ...
 */
internal fun Context.getFacingDirection(cameraId: String) =
 ...
 */
internal fun <T : Any> Context.getCameraOutputSizes(klass: Class<T>, cameraId: String): List<Size> {
 ...
 */
internal fun Context.isFrameRateSupported(cameraId: String, fps: Int) =
 ...
 */
internal fun Context.isFlashAvailable(cameraId: String): Boolean =
 ...
 */
internal fun Context.getAutoWhiteBalanceModes(cameraId: String): List<Int> {
 ...
 */
internal fun Context.getWhiteBalanceMeteringRegionsSupported(cameraId: String): Int {
 ...
 */
internal fun Context.getAutoExposureModes(cameraId: String): List<Int> {
 ...
 */
internal fun Context.getExposureRange(cameraId: String): Range<Int> {
 ...
 * @return exposure range.
 */
internal fun Context.getExposureStep(cameraId: String): Rational {
 ...
 * @return true if camera supports metering regions, false otherwise
 */
internal fun Context.getExposureMaxMeteringRegionsSupported(cameraId: String): Int {
 ...
 */
internal fun Context.getZoomRatioRange(cameraId: String): Range<Float> {
 ...
 * @return list of supported auto focus modes
 */
internal fun Context.getAutoFocusModes(cameraId: String): List<Int> {
 ...
 */
internal fun Context.getLensDistanceRange(cameraId: String): Range<Float> {
    return Range(
        0f,
 ...
 * @return true if camera supports metering regions, false otherwise
 */
internal fun Context.getFocusMaxMeteringRegionsSupported(cameraId: String): Int {
 ...
 */
internal fun Context.isOpticalStabilizationAvailable(cameraId: String): Boolean =
 ...
 */
internal fun Context.computeRelativeRotation(
    cameraId: String,
 ...
 */
internal fun Context.getCameraOutputStreamSizes(): List<Size> {
 ...
 */
internal fun Context.getCameraOutputStreamSizes(cameraId: String): List<Size> {
    return this.getCameraCharacteristics(cameraId)[CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP]?.getOutputSizes(
        ImageFormat.YUV_420_888
    )?.toList() ?: emptyList()
}

internal fun Context.getCameraOutputOrientation(cameraId: String): Int {
    return this.getCameraCharacteristics(cameraId)[CameraCharacteristics.SENSOR_ORIENTATION]!!
}
 ...
 */
internal fun Context.getCameraFpsList(cameraId: String): List<Range<Int>> {
